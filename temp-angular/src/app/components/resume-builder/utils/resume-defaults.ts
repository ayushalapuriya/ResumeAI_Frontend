...
// Extracted here so the builder component stays lean and data is easy to replace.
// ─────────────────────────────────────────────────────────────────────────────

import { ResumeData, SectionItem } from '../models/resume.model';
...
export const BUILDER_SECTIONS: SectionItem[] = [
...
/** Fallback accent colours keyed by templateId when no CSS variable is present */
export const TEMPLATE_ACCENT_PALETTE: Record<number, string> = {
  1: '#6366f1',
  2: '#0f172a',
  3: '#64748b',
  4: '#ec4899',
